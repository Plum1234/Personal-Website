      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="space-y-6">
          {site.research.map((paper) => (
            ...
            >
              <p className="font-mono text-xs text-teal-500/80">{paper.venue}</p>
              <h3 className="mt-2 text-lg font-medium text-zinc-100 group-hover:text-teal-400 transition-colors">
                {paper.title}
              </h3>
              ...
              <p className="mt-3 text-sm text-teal-500/70 group-hover:text-teal-400">
                Read paper →
              </p>
            </a>
          ))}
